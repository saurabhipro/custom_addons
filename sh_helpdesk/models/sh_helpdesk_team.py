...
class HelpdeskTeam(models.Model):
    ...
    @api.model
    def sh_get_team_members(self,**kw):
        team_members=[]
        if kw and kw.get('team'):
            team = self.env['sh.helpdesk.team'].browse(kw.get('team'))
            
            if team:
                team_members=team.team_members.ids+[team.team_head.id]
