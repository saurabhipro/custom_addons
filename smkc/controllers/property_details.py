...
class PropertyDetailsAPI(http.Controller):
    ...
    def dashboard_summary(self, **kwargs):
        try:
            ...
            data = {
                'uploaded': Property.search_count([('surveyer_id','=',surveyor_id),('create_date','>=', date_from),('create_date','<', date_to),('property_status', '=', 'uploaded')]),
                'pdf_downloaded': Property.search_count([('surveyer_id','=',surveyor_id),('create_date','>=', date_from),('create_date','<', date_to),('property_status', '=', 'pdf_downloaded')]),
                'surveyed': Property.search_count([('surveyer_id','=',surveyor_id),('create_date','>=', date_from),('create_date','<', date_to),('property_status', '=', 'surveyed')]),
                'discovered': Property.search_count([('surveyer_id','=',surveyor_id),('create_date','>=', date_from),('create_date','<', date_to),('property_status', '=', 'discovered')]),
            }
