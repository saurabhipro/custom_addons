...
export class PropertyMapView extends Component {
    static template = "smkc.PropertyMapView";
    static components = {};
    ...
    async loadFilters() {
        try {
            const zones = await this.orm.call('smkc.zone', 'search_read', [[]], { fields: ['id', 'name'] });
            ...
            const wards = await this.orm.call('smkc.ward', 'search_read', [[]], { fields: ['id', 'name', 'zone_id'] });
